...
set PATH=C:\Windows\System32;%kivy_portable_root%;%kivy_portable_root%Python;%kivy_portable_root%Python\Scripts;%kivy_portable_root%gstreamer\bin;%kivy_portable_root%MinGW\bin;%PATH%
ECHO PATH:
ECHO %PATH%
ECHO ----------------------------------

set PYTHONPATH=%kivy_portable_root%kivy;%kivy_portable_root%kivy\kivy\modules;%kivy_portable_root%kivy\kivy
ECHO PYTHONPATH:
ECHO %PYTHONPATH%
ECHO ----------------------------------
